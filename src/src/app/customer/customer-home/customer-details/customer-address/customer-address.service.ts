...
export class CustomerAddressService {
    ...
    deleteAddress(addressToDelete: Address, customerEmailId: string): Observable<string> {
        let url: string = environment.customerAPIUrl + "/customers/" + customerEmailId + "/address/" + addressToDelete.addressId ;
        return this.http.delete<string>(url, null, { headers: this.headers, responseType: 'text' as 'json' })
            .pipe(
    ...
    addNewAddress(addressToadd: Address, customerEmailId: string): Observable<string> {
        let url: string = environment.customerAPIUrl + "/customers/" + customerEmailId + "/addresses";
