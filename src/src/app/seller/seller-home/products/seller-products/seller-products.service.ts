...
export class SellerProductsService {
  ...
  getProductCategories(): Observable<string[]> {
    const url = environment.productAPIUrl + "/productCategories";
  ...
  updateProductDetails(product: Product): Observable<Product> {
    const url = environment.SellerProductManagementAPI + "/products";
  ...
  removeProductFromSeller(product: Product): Observable<Product> {
    const url = environment.SellerProductManagementAPI + "/sellers/products";
